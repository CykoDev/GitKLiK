                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white bg-transparent">
                        <div class="row align-items-center">
                            <div class="col">
                                <h6 style="color:#1E1E1E" class="text-uppercase ls-1 mb-1">Overview</h6>
                                <h2 style="color:#1E1E1E" class="mb-0">Contributions</h2>
                            </div>
                            <div class="col">
                    ...
                    <div class="card-header  border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col text-right">
                                <a style="background:#FF9000;color:white" href="#!" class="btn btn-sm">See all</a>
                            </div>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <!-- Projects table -->
                        <table class=" bg-secondary table align-items-center table-flush">
